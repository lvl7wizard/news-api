const { fetchTopics, fetchEndpoints, fetchArticleById, fetchAllArticles, fetchCommentsByArticleId, addComment, updateArticle, removeCommentById } = require('../models/news.models')
