...
const app = express();
const { getTopics, getEndpoints, getArticlesById, getAllArticles, getCommentsByArticleId, getUsers, postComment, patchArticle, deleteComment } = require('./controllers/news.controllers')
