...
const app = express();
const { getTopics, getEndpoints, getArticlesById, getArticles, getCommentsByArticleId, getUsers, postComment, patchArticle, deleteComment } = require('./controllers/news.controllers')
